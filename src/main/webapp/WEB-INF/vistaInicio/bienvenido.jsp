...
<html>
    <head>
        ...
        <link href="<c:url value="/static/assets/css/jquery-ui-1.10.3.custom.min.css"/>" rel="stylesheet"/>
    ...
    <body>
        ...
        <div class="main-container container-fluid">
            ...
            <div class="main-content">
               ...
               <div class="table-header"><h3>Lista de Productos</h3></div>
                    <table class="table table-striped">
                        ...
                        <tbody>
                            <c:forEach items="${productos}" var="producto">
                                <tr>
                                    <td><c:out value="${producto.prodCod}"></c:out></td>
                                    <td><c:out value="${producto.prodNombre}"></c:out></td>
                                    <td>$<c:out value="${producto.prodPrecio}"></c:out>.-</td>            
                                    <td><c:out value="${producto.prodStock}"></c:out></td>            
                                </tr>
                            </c:forEach>
                        </tbody>
                    </table>
